        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="relative">
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-3xl border border-line shadow-[var(--shadow-card-hover)]">
              <Image
                src="https://datadiorama.com/wp-content/uploads/2025/03/datadiorama-7864.jpg"
                alt="datadiorama Technikerinnen und Techniker bei der Arbeit an einem Computer"
                fill
