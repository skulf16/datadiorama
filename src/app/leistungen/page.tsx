...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Alle IT-Leistungen von datadiorama im Überblick: IT-Beratung, Netzwerkbetreuung, Microsoft 365, Cloud, Software Engineering, Telefonanlagen und mehr – aus einer Hand.",
  path: "/leistungen",
});
